...
# Save the plot
ggplot2::ggsave(
  here::here("intergen-mobility-and-pollution.png"),
...
mobility_plot <- ggplot2::ggplot(
  ...
  ggplot2::labs(
    ...
    subtitle = "Mean Child Percentile Rank for Parents at 25\U1D57\U02B0 National Income Percentile",
  ...
  ggplot2::theme(
    ...
    plot.title = ggplot2::element_text(face = "bold", hjust = 0.65),
    plot.subtitle = ggplot2::element_text(hjust = 0.65),
    legend.title = ggplot2::element_blank()
  ) +
  ggplot2::guides(
...
ggplot2::ggsave(
  here::here("intergen-mobility.png"),
  plot = mobility_plot,
  width = 12,
  height = 8
)
