...
## Create buffers around all monitors

```{r}
#| echo: false
#| warning: false
#| message: false
#| fig-subcap: Monitors with 10 mile buffer
#| fig-width: 10
#| fig-height: 5
#| fig-align: "center"
mn_shape <- tigris::states(progress_bar = FALSE) |>
...
ggplot2::ggplot(mn_shape) +
  ...
  ggplot2::labs(title = "PM2.5 Monitors") +
  theme_minimal_light()
```
...
ggplot2::ggplot(
  ...
  ggplot2::labs(
    title = "Mean County-level PM2.5 Pollution",
    fill = "\U03BCg/m\U00B3"
  ) +
